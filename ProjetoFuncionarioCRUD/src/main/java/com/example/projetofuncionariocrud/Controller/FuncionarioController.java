...
import com.example.projetofuncionariocrud.Model.EnderecoModel;
import com.example.projetofuncionariocrud.Model.FuncionarioModel;
import com.example.projetofuncionariocrud.Util.ExportadorCSV;
...
public class FuncionarioController {
    ...
    private void salvarFuncionario() {
        try {
            ...
            limparCampos();
            inicializarFiltros();
            String caminho = "src/main/resources/funcionarios.csv";
            ExportadorCSV.exportarFuncionarios(repo.listarTodos(), caminho);
    ...
    private void atualizarListaFiltrada() {
        List<FuncionarioModel> todosFuncionarios = (List<FuncionarioModel>) repo.listarTodos();
        tabelaFiltrados.setItems(FXCollections.observableArrayList(Collections.unmodifiableList(todosFuncionarios)));
    }
}
